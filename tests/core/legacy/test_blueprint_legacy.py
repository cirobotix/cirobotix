...
def test_blueprint_creation_happy_path():
    bp = Blueprint(
        name="TestBlueprint", component_type="TypeA", required_fields=["field1", "field2"]
    )
...
def test_blueprint_list_default_independence():
    bp1 = Blueprint(
        name="TestBlueprint1", component_type="TypeA", required_fields=["field1", "field2"]
    )
    bp2 = Blueprint(
        name="TestBlueprint2", component_type="TypeB", required_fields=["field3", "field4"]
    )
